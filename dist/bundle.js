...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }\n\nfunction _nonIterableRest() { throw new TypeError(\"Invalid attempt to destructure non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\nfunction _iterableToArrayLimit(arr, i) { if (typeof Symbol === \"undefined\" || !(Symbol.iterator in Object(arr))) return; var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i[\"return\"] != null) _i[\"return\"](); } finally { if (_d) throw _e; } } return _arr; }\n\nfunction _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }\n\n{// expected element\n\n  /* \r\n  <article class=\"modal\">\r\n  <section class=\"modal__image-wrap\">\r\n    <article class=\"modal__image\" style=\"background-image: url(~);\"></article>\r\n  </section>\r\n  <ul class=\"modal__infos\">\r\n    <li class=\"modal__info\"><p class=\"modal__info__text modal__info__text--name\">${name}</p></li>\r\n    <li class=\"modal__info\"><p class=\"modal__info__text\">gender: ${gender}</p></li>\r\n    <li class=\"modal__info\"><p class=\"modal__info__text\">size: ${size}</p></li>\r\n  </ul>\r\n  <section class=\"modal__close-btn-wrap\">\r\n    <button class=\"modal__close-btn\">close</button>\r\n  </section>\r\n  </article>\r\n  */\n}\n\nvar handleModalCloseBtnClick = function handleModalCloseBtnClick() {\n  var modal = document.querySelector('.modal');\n  modal === null || modal === void 0 ? void 0 : modal.remove();\n};\n\nvar createProductsDetailModal = function createProductsDetailModal(imageUrl, name, gender, size) {\n  var _app$querySelector;\n\n  var app = document.querySelector('.app');\n  if (app.lastChild.className === 'modal') return; // 이미 모달이 있다면 return\n\n  var modal = document.createElement('article');\n  modal.classList.add('modal');\n  console.log(imageUrl);\n  modal.innerHTML = \"\\n<section class=\\\"modal__image-wrap\\\">\\n  <article class=\\\"modal__image\\\" style=\\\"background-image: url(\".concat(imageUrl, \");\\\"></article>\\n</section>\\n<ul class=\\\"modal__infos\\\">\\n  <li class=\\\"modal__info\\\"><p class=\\\"modal__info__text modal__info__text--name\\\">\").concat(name, \"</p></li>\\n  <li class=\\\"modal__info\\\"><p class=\\\"modal__info__text\\\">gender: \").concat(gender, \"</p></li>\\n  <li class=\\\"modal__info\\\"><p class=\\\"modal__info__text\\\">size: \").concat(size, \"</p></li>\\n</ul>\\n<section class=\\\"modal__close-btn-wrap\\\">\\n  <button class=\\\"modal__close-btn\\\">close</button>\\n</section>\\n\").trim();\n  app.append(modal);\n  (_app$querySelector = app.querySelector('.modal__close-btn')) === null || _app$querySelector === void 0 ? void 0 : _app$querySelector.addEventListener('click', handleModalCloseBtnClick, false);\n};\n\nvar handleClick = function handleClick(e) {\n  if (e.target.tagName === 'UL') return; // 클릭된게 상품이 아닌 부모 wrapper라면 return\n\n  var item = e.target.closest('li');\n  var imageUrl = item.querySelector('.app__products__item__image').style.backgroundImage.match(/(?<=url\\(\").*(?=\"\\))/)[0];\n  var name = item.querySelector('.app__products__item__name').textContent;\n\n  var _item$querySelector$t = item.querySelector('.app__products__item__gender-size').textContent.match(/([a-z]+), ([a-z]+)/),\n      _item$querySelector$t2 = _slicedToArray(_item$querySelector$t, 3),\n      _ = _item$querySelector$t2[0],\n      gender = _item$querySelector$t2[1],\n      size = _item$querySelector$t2[2];\n\n  createProductsDetailModal(imageUrl, name, gender, size);\n};\n\nvar onProductsClickEvent = function onProductsClickEvent() {\n  var itemList = document.querySelector('.app__products__list');\n  itemList === null || itemList === void 0 ? void 0 : itemList.addEventListener('click', handleClick, false);\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (onProductsClickEvent);\n\n//# sourceURL=webpack:///./src/js/client/_onProductsClickEvent.js?");

/***/ }),

/***/ "./src/js/client/_preloadImages.js":
/*!*****************************************!*\
  !*** ./src/js/client/_preloadImages.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nvar preloadImages = function preloadImages() {\n  // 이미지 디렉터리 경로\n  var IMG_DIR_PATH = 'https://bear-bear-bear.github.io/minimi-shopping-web/src/img';\n  var images = {\n    blue: ['t', 'p', 's'],\n    yellow: ['t', 'p', 's'],\n    pink: ['t', 'p', 's']\n  };\n  var allPath = Object.keys(images).reduce(function (acc, color) {\n    var categorys = images[color];\n    var paths = categorys.map(function (category) {\n      return \"\".concat(IMG_DIR_PATH, \"/\").concat(color, \"_\").concat(category, \".png\");\n    });\n    acc.push(paths);\n    return acc;\n  }, []).flat();\n  allPath.forEach(function (path) {\n    var img = new Image();\n    img.src = path;\n  });\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (preloadImages);\n\n//# sourceURL=webpack:///./src/js/client/_preloadImages.js?");
